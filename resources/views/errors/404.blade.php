...
<head>
    ...
    <title>404 ERROR &ndash; HALAMAN TIDAK DITEMUKAN | {{env('APP_TITLE')}}</title>
...
@if(Auth::guard('admin')->check() && Request::is('sys-admin*'))
    <a href="{{route('admin.dashboard')}}">Alihkan saya ke halaman Dashboard!</a>
@else
