...
@section('title', 'Admin '.env('APP_NAME').': Pengaturan Akun | '.env('APP_TITLE'))
@push('styles')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Pengaturan Akun</div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row form-group">
                                    <div class="col has-feedback">
                                        <label for="email">E-mail Utama (verified)</label>
                                ...
                                <div class="row form-group">
                                    <div class="col has-feedback">
                                        <label for="curr_password">Password Saat Ini</label>
                                        <input id="curr_password" type="password" class="form-control" minlength="6"
                                               name="password" placeholder="Password saat ini" required>
                                ...
                                <div class="row form-group">
                                    <div class="col has-feedback">
                                        <label for="as-password">Password Baru</label>
                                ...
                                <div class="row">
                                    <div class="col has-feedback">
                                        <label for="as-confirm">Konfirmasi Password</label>
