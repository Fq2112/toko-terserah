<form id="setting-form" enctype="multipart/form-data" action="{{route('admin.setting.general.update')}}" method="post">
    ...
    <div class="card-body">
        <p class="text-muted">Pengaturan Website Mencakupi Email, Alamat,  Logo dsb.</p>
        ...
        <div class="form-group row align-items-center">
            <label for="site-description" class="form-control-label col-sm-3 text-md-right">Alamat Toko</label>
            <div class="col-sm-6 col-md-9">
        ...
        <div class="form-group row align-items-center">
            <label class="form-control-label col-sm-3 text-md-right">Logo Web</label>
            <div class="col-sm-6 col-md-9">
                <div>
