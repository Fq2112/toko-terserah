...
@section('title', 'Admin '.env('APP_NAME').': Inbox | '.env('APP_TITLE'))
@push('styles')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Kotak Masuk</div>
            </div>
        </div>
        ...
        <div class="section-body">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <button id="compose" class="btn btn-sm btn-primary" type="button">
                                    <strong><i class="fas fa-edit"></i>&ensp;BUAT PESAN</strong>
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                            @if(count($contacts) > 0)
                                <a href="javascript:void(0)" data-toggle-slide="#message-items"
                                   class="btn btn-primary btn-icon icon-left btn-lg btn-block mb-4 d-md-none">
                                    <i class="fas fa-list"></i> Semua Pesan</a>
                                <div class="tickets">
                            ...
                            @else
                                ...
                                <h5><em>Tampaknya tidak ada pesan yang ditemukan&hellip;</em></h5>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="compose col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="compose-header">
                    <strong id="compose_title">Pesan Baru</strong>
