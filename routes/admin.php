...
Route::group(['namespace' => 'Pages\Admins'], function () {
    ...
    Route::group(['prefix' => 'order'], function () {
        ...
        Route::get('tgl_berangkat', [
            'uses' => 'OrderController@update_tgl_pengririman_toko_terserah',
            'as' => 'order.berangkat'
        ]);
        ...
        Route::get('download/invoice/{user_id}/{code}', [
            'uses' => 'OrderController@get_download_invoice',
            'as' => 'admin.order.invoice.get'
        ]);
